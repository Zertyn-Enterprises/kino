...
npm run dogfood:scaffold                                                     # render-smoke a fresh --hook/--body/--distinct/--ambient scaffold — run locally before merging scaffold or src/lib changes; pixel-verifies gate-green-by-construction claim (distinct identity seed + all 3 non-strips ambient motifs)
