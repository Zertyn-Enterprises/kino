...
- `node scripts/new-video.mjs <slug> <CompId>` — scaffold new video skeleton (hook-gate-green by construction: P1/P2 + AmbientField living-background + valid starter palette + Hook scene with promise.text)
