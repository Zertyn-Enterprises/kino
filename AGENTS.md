...
- `scripts/distinct.sh <slug> [--bg=#.. --accent=#.. --luminance=.. --arc=. --bpm=.. --grain=..]` — distinctiveness gate: ≥4-axis anti-template rule (D1 HARD, drift advisory, no render) → out/review/<slug>/distinct/
